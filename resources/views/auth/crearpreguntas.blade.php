...
<div class="w-2/4 h-2/4 bg-blue-300 shadow rounded flow-root flex m-auto mt-8 ">
    ...
    <form action="{{route('docente.guardarpregunta')}}" method="POST" >
        @csrf
        ...
        <div class="mb-4 relative ml-7 mr-7 mt-3 ">
            ...
            <div class="relative shadow-sm  rounded ">
                <div>
                    <input type="text" name="pregunta" class="shadow appearence-none border-rounded w-full py-2 px-4.5 pr-3 pl-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Ingrese la pregunta" value="{{old('pregunta')}}" required>
        ...
        <div class="mb-4 relative ml-7 mr-7 mt-3 ">
            ...
            <div class="relative shadow-sm  rounded ">
                <div>
                    <input type="text" name="opcion1" class="shadow appearence-none border-rounded w-full py-2 px-4.5 pr-3 pl-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Ingrese la respuesta" value="{{old('opcion1')}}" required>
        ...
        <div class="mb-4 relative ml-7 mr-7 mt-3 ">
            ...
            <div class="relative shadow-sm  rounded ">
                <div>
                    <input type="text" name="opcion2" class="shadow appearence-none border-rounded w-full py-2 px-4.5 pr-3 pl-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Ingrese la respuesta" value="{{old('opcion2')}}" required>
        ...
        <div class="mb-4 relative ml-7 mr-7 mt-3 ">
            ...
            <div class="relative shadow-sm  rounded ">
                <div>
                    <input type="text" name="opcion3" class="shadow appearence-none border-rounded w-full py-2 px-4.5 pr-3 pl-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Ingrese la respuesta" value="{{old('opcion3')}}" required>
        ...
        <div class="mb-4 relative ml-7 mr-7 mt-3 ">
            ...
            <div class="relative shadow-sm  rounded ">
                <div>
                    ...
                    <!-- correcta con lista usando radio button-->
                ...
                {{-- radio button con multiples opciones --}}
                <div class='mb-4 relative'>
                    <div class='relative rounded shadow-sm'>
                        <div>
    ...
    <a href="{{route('docente.show')}}"><button class="bg-gray-400 hover:bg-blue-500 text-black shadow-md rounded border-2 border-gray-300 py-2 px-4 w-1/4 mr-7 mb-5 float-right m-auto mt-2">Terminar</button></a>
</div>
