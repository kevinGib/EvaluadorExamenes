...
@section('content')
<div class="block mx-auto my-12 p-8 gb-white w-1/4 border border-gray-200 rounded-lg shadow-lg">

    <h1 class="text-3xl text-center font-blod">Iniciar sesion</h1>
    ...
    <form class="mt-4" method="POST" action="">
        ...
        <button type="submit" class="rounded-md bg-indigo-500 w-full text-lg text-white font-semiblod p-2 my-3 hover:bg-indigo-600">Iniciar Sesion</button>
    </form>
</div>
