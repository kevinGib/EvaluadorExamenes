...
@section('content')
    ...
    <div class="w-3/4 bg-whit5 h-3/4 m-auto shadow rounded mt-8 flow-root">
        <div class="border border-2px h-10 bg-white text-center">
            ...
            <a href="{{route('alumno.pdfAlumno')}}"> <button class="hover:bg-blue-50 shadow rounded bg-gray-300 mb-5 mt-1 mr-2 py-1 px-7 float-right">PDF</button></a>
        </div>
        ...
        <table class="table w-full px-16 ml-auto flex justify-between pt-2 ">
           <thead>
            <tr>
                ...
                <th class="border border-gray-500 px-2 py-2 text-white bg-blue-500 "> Id Docente</th>
                <th class="border border-gray-500 px-2 py-2 text-white bg-blue-500">
                    Id Alumno </th>
